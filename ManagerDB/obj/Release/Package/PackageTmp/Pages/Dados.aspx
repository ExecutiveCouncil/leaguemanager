        ...
        <div class="row">
            <div class="col-md-12">
                <h1>
                    ...
                    <asp:Label runat="server" ID="_LbTitle" Text="PANEL DE CONTROL"></asp:Label>
                </h1>
                <hr />
            </div>
        </div>
    ...
    <asp:Panel ID="PnlPopUp" runat="server" CssClass="PopUp" style="display:none">
        ...
        <div class="div_box">            
            <div>
                ...
                <div style="margin-left:25px">
                    <asp:Label runat="server" ID="LbObservaciones" Text="Notas para el organizador (P.ej: jugador objetivo)"></asp:Label>
                    <br />
